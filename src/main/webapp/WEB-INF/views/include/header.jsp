            ...
            <div id="main_right">
                ...
                <c:when test="${not empty sessionScope.userID}">
                    <div id="location" class="lfc">
                    	<a href="/ex/mykurly/deliverylist"><span class="material-icons-outlined">room</span></a>
                	</div>
                ...
                <c:otherwise>
                	...
                	<div id="location" class="lfc">
                    	<a style="cursor: pointer;" onclick="notlongin()"><span class="material-icons-outlined">room</span></a>
                	</div>
	                <div id="favorit" class="lfc">
